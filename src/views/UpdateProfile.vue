			...
			<table>
				<tbody>
					<tr>
						...
						<td>
							<input id='input_email' name="email" :value="user?.email" placeholder='your@email.com' required>
					...
					<tr>
						...
						<td>
							<input id='input_name' name="name" :value="user?.name" placeholder='Your name (required)' required>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input id='input_birthdate' name="birthdate" :value="user?.birthdate || ''" type="date">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							...
							-->
							<input id='input_emailPublic' name="email_public" type="checkbox" :disabled="!user?.email_verified" :checked="user?.email_public && user?.email_verified">
					...
					<tr>
						...
						<td>
							<span id="span_emailVerified" :class="user?.email_verified ? 'true' : 'false'"></span>
